...
The companion to **PLANCK** lives at **https://ivanroche.com/planck/** — private and
password-protected. This file explains how to publish it, lock it down, and regenerate the
generated parts after edits. The chapter structure follows the **V5 manuscript**.
...
│   ├── planck-manifest.json     canonical list of every station (source of truth, V5-aligned)
...
├── qr/                          36 QR PNGs + index.html (printable sheet) + qr_map.csv
├── chapter-01/ … chapter-11/    each chapter: lab *.html, figures/ (png/gif), python/ (generators)
